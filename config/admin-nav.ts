...
export const ADMIN_NAV_ITEMS: AdminNavItem[] = [
  // Overview
  { name: "Overview", href: "/dashboard", icon: LayoutDashboard, permissionKey: "canViewOverview" },

  // Analytics
  { name: "Analytics", href: "/dashboard/analytics", icon: BarChart3, permissionKey: "canViewAnalytics" },

  // Live Map
  { name: "Live Map", href: "/dashboard/live-map", icon: Map, permissionKey: "canManageZones" },
